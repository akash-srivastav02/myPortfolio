                    ...
                    cardItem.map(({id, logo, name}) => (
                        ...
                        <div className="md:w-[600px] md:h-[250px] border-[2px] p-1 rounded-lg shadow-lg cursor-pointer hover:scale-105 mb-2 md:mb-4 place-content-center" key={id}>
                            ...
                            <div className="ml-2">
                                ...
                                <p className="px-2 text-gray-900 dark:text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet, ut d totam optio!.</p>
                            </div>
